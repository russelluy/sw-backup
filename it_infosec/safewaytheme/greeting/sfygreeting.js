...
// You can safely use $ in this code block to reference jQuery
	...
	$("#greetingContainer1").text('Welcome to Information Security');
	var loc = getAbsolutePath();
	//alert(loc);
	$("a#logo-url").attr("href", loc);
	$("img#logo-url-img").attr("alt", "Safeway Information Security");
	$("img#logo-url-img").attr("src", "/it_infosec/wp-content/themes/safewaytheme/images/safeway-logo250.jpg");
