...
// You can safely use $ in this code block to reference jQuery
	...
	$("#greetingContainer1").text('Welcome to Market Research');
	var loc = getAbsolutePath();
	//alert(loc);
	$("a#logo-url").attr("href", loc);
	$("img#logo-url-img").attr("alt", "Market Research Website");
	$("img#logo-url-img").attr("src", "/marketresearch/wp-content/themes/safewaytheme/images/safeway-logo250.jpg");
