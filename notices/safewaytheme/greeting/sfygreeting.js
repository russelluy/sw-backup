...
// You can safely use $ in this code block to reference jQuery
	...
	$("#greetingContainer1").text('Welcome to Notices');
	var loc = getAbsolutePath();
	//alert(loc);
	$("a#logo-url").attr("href", loc);
	$("img#logo-url-img").attr("alt", "Safeway Notices");
	$("img#logo-url-img").attr("src", "/notices/wp-content/themes/safewaytheme/images/safeway-logo250.jpg");
