						...
						<div id="post-<?php the_ID(); ?>" class="<?php hybrid_entry_class(); ?>">
							...
							<div class="entry-content">
								...
								<?php else : ?>
									...
									<p class="download">
										<a href="<?php echo wp_get_attachment_url(); ?>" title="<?php the_title_attribute(); ?>" rel="enclosure" type="<?php echo get_post_mime_type(); ?>"><?php printf( __( 'Download &quot;%1$s&quot;', 'NorcalTheme' ), the_title( '<span class="fn">', '</span>', false) ); ?></a>
									</p><!-- .download -->
