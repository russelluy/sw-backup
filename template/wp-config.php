...
define('WP_PROXY_HOST', 'xslcbc01-int.safeway.com');
...
define('DB_USER', 'templateadmin');

/** MySQL database password */
define('DB_PASSWORD', 'wh@tsUp!@');

/** MySQL hostname */
define('DB_HOST', 'scvgdv83.safeway.com');
...
/**
*configuration related to Safeway portal
*/
