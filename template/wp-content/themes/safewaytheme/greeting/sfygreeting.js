...
// You can safely use $ in this code block to reference jQuery
	...
	$("#greetingContainer1").text('Welcome to Template Website');
	var loc = getAbsolutePath();
	//alert(loc);
	$("a#logo-url").attr("href", loc);
	$("img#logo-url-img").attr("alt", "Safeway Template Website");
	$("img#logo-url-img").attr("src", "/template/wp-content/themes/safewaytheme/images/safeway-logo250.jpg");
