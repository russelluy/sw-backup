            	     ...
            	     <?php } ?>
	                    ...
	                    <div id="content2">
	                    		<div class="newcolumns_top">
	                    			<?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Vision Mission')) { ?>
			            	     					<?php } ?>
	                    		</div>
	                    		...
	                    		<div class="newcolumns">
					                   ...
					                   <div class="maincontent_c">
					                   			<div class="maincontent_c_box1" >
					                   				...
					                   				<?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Bucket #1')) { ?>
			            	     					<?php } ?>
					                  			 </div>
					                  			 <div class="maincontent_c_box2">
					                  			 <?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Bucket #2')) { ?>
			            	     					<?php } ?>
					                  			 </div>
					                  			 <div class="maincontent_c_box3">
					                  			 <?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Bucket #3')) { ?>
			            	     					<?php } ?>
					                  			 </div>
												 <div class="maincontent_c_box4">
					                  			 <?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Bucket #4')) { ?>
			            	     					<?php } ?>
					                  			 </div>
												 <div class="maincontent_c_bottom">
					                  			 </div>
					                   </div>
					                   ...
					                   <div class="clear"></div>
			                   			...
			                   			<div class="newcolumns_bot_msg">
					                   		 <?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Bottom Message')) { ?>
			            	     					<?php } ?>
					                   </div>
	                 	</div>
