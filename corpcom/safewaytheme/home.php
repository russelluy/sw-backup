...
<div id="content1b">
  ...
  <div id="content2">
    ...
    <div class="newcolumns"> 
      ...
      <h2 class="welcome_title">Corporate Communications Welcomes You!</h2>
      <p class="welcome_message">We act as a strategic business partner to leaders and groups throughout the organization. The scope of the work we
        do is far-reaching and ever evolving. Our team brings a variety of backgrounds to the communications we create. <br />
        <br />
        Corporate Communications facilitates clear, concise, consistent communications anytime, anywhere to keep up with
        the speed of business and provide Safeway employees with the information they need to better do their jobs. <br />
        <br />
        Through the use of consistent practices, coordinated timing and standardized process, the Corporate
        Communications team is able to align our messages with core company-wide programs that maximise their
        effectiveness and help drive employee engagement across the organization.</p>
