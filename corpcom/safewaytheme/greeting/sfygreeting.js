...
// You can safely use $ in this code block to reference jQuery
	...
	$("#greetingContainer1").text('Welcome to Corporate Communications');
	var loc = getAbsolutePath();
	//alert(loc);
	$("a#logo-url").attr("href", loc);
	$("img#logo-url-img").attr("alt", "Safeway Corporate Communications");
	$("img#logo-url-img").attr("src", "/corpcom/wp-content/themes/safewaytheme/images/safeway-logo250.jpg");
