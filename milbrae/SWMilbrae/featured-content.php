...
$args = array( 'posts_per_page' => 6, 'meta_key' => '_SWMilbrae_post_location', 'meta_value' => 'featured', 'post__not_in' => get_option( 'sticky_posts' ) );
	...
	<div class="featured-wrapper">
		...
		<div id="featured-content">		
			...
			<?php while ( $loop->have_posts() ) : $loop->the_post(); ?>
					...
					<div class="featured-post">
						...
						<?php echo apply_atomic_shortcode( 'byline', '<div class="byline">' . __( '[entry-published]', 'SWMilbrae' ) . '</div>' ); ?>
		...
		<div id="slider-nav">
			...
			<ul id="slide-thumbs">
				...
				<?php $slidecount = 1;
				$args = array( 'meta_key' => '_SWMilbrae_post_location', 'meta_value' => 'featured', 'post__not_in' => get_option( 'sticky_posts' ) );
