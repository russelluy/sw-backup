<?php
	 ...
	 */
	function swblog_alert($atts, $content = null){
	 ...
	 */
	function swblog_social($atts, $content = null){
	 ...
	 */
	function swblog_label($atts, $content = null){
	 ...
	 */
	function swblog_badge($atts, $content = null){
	 ...
	 */
	function swblog_well($atts, $content = null){
	 ...
	 */
	function swblog_button($atts, $content = null){
	 ...
	 */
	function swblog_blockquote( $atts, $content = null) {
	 ...
	 */
	function swblog_syntax( $atts, $content = null) {
	 ...
	 */
	function swblog_tooltip( $atts, $content = null)
	{
	 ...
	 */
	function swblog_popover( $atts, $content = null)
	{
	 ...
	 */
	function swblog_accordion($atts, $content = null){
	...
	function swblog_accordion_group($atts, $content = null){
	 ...
	 */
	function swblog_divider( $atts, $content = null ) {
	...
	function swblog_process_shortcode($content) {
	    global $shortcode_tags;
	 
	    $original_shortcode_tags = $shortcode_tags;
	    remove_all_shortcodes();
	    
		add_shortcode('divider', 'swblog_divider');
		add_shortcode('social', 'swblog_social');
		add_shortcode('alert', 'swblog_alert');
		add_shortcode('label', 'swblog_label');
		add_shortcode('badge', 'swblog_badge');
		add_shortcode('well', 'swblog_well');
		add_shortcode('button', 'swblog_button');
		add_shortcode('blockquote', 'swblog_blockquote');
		add_shortcode('syntax', 'swblog_syntax');
		add_shortcode('tooltip', 'swblog_tooltip');
		add_shortcode('popover', 'swblog_popover');
		add_shortcode('accordion', 'swblog_accordion');
		add_shortcode('accordion-group', 'swblog_accordion_group');
	...
	add_filter('the_content', 'swblog_process_shortcode', 7);

	// Shortcodes in widget
	add_filter('widget_text', 'swblog_process_shortcode', 7);
