...
class bl_html extends WP_Widget {
	...
	function bl_html(){
		...
		$this->WP_Widget('bl_html', 'swblog HTML', $widget_ops);
	}
	...
	function widget( $args, $instance ) {
		...
		if($instance['white_bg'] == 'false'){
			echo preg_replace('/class="[^"]*"/','class="cleanwidget bl_html'.$add_padding.'"', $before_widget);
		}else{
			echo preg_replace('/class="[^"]*"/','class="box bl_html'.$add_padding.'"', $before_widget);
		}
