...
class bl_socialbox extends WP_Widget
{
  function bl_socialbox(){
    ...
    $this->WP_Widget('bl_socialbox', 'swblog Socialbox', $widget_ops);
  }
  ...
  function widget($args, $instance){
    ...
    echo preg_replace('/class="[^"]*"/','class="box bl_socialbox"', $before_widget);
    ?>
  		<?php echo !empty($instance['title']) ? '<h3 class="widget-head">'.$instance['title'].'</h3>' : '' ?>
    	<div class="widget-body">
    		<ul class="clearfix">
	    	<?php echo !empty($instance['facebook']) 	? '<li><a target="_blank" data-title="Facebook" class="tips bl_icon_facebook" href="'.$instance['facebook'].'"><i class="icon-facebook"></i></a></li>' : '' ?>
	    	...
	    	<?php echo !empty($instance['googleplus']) 	? '<li><a target="_blank" data-title="Google+" class="tips bl_icon_googleplus" href="'.$instance['googleplus'].'"><i class="icon-gplus"></i></a></li>' : '' ?>
	    	...
	    	<?php echo !empty($instance['rss']) 		? '<li><a target="_blank" data-title="Rss" class="tips bl_icon_rss" href="'.$instance['rss'].'"><i class="icon-rss"></i></a></li>' : '' ?>
	    	<?php echo !empty($instance['flickr']) 		? '<li><a target="_blank" data-title="Flickr" class="tips bl_icon_flickr" href="'.$instance['flickr'].'"><i class="icon-flickr-circled"></i></a></li>' : '' ?>
	    	...
	    	<?php echo !empty($instance['pinterest']) 	? '<li><a target="_blank" data-title="Pinterest" class="tips bl_icon_pinterest" href="'.$instance['pinterest'].'"><i class="icon-pinterest-circled"></i></a></li>' : '' ?>
	    	<?php echo !empty($instance['dribbble']) 	? '<li><a target="_blank" data-title="Dribbble" class="tips bl_icon_dribbble" href="'.$instance['dribbble'].'"><i class="icon-dribbble"></i></a></li>' : '' ?>
