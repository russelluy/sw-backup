...
// You can safely use $ in this code block to reference jQuery
	...
	$("#greetingContainer1").text('Welcome to Human Resources');
	var loc = getAbsolutePath();
	//alert(loc);
	$("a#logo-url").attr("href", loc);
	$("img#logo-url-img").attr("alt", "Safeway Human Resources");
	$("img#logo-url-img").attr("src", "/hr/wp-content/themes/safewaytheme/images/safeway-logo250.jpg");
