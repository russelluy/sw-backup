            ...
            <div class="contentbodywrap">	
               	<div id="content1b">
                    ...
                    <div class="newcolumns_top">
	                    			<?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Blog Area')) { ?>
			            	     					<?php } ?>
	                    		</div>
                   
               		<div class="horizontalline"><h2>Resources</h2></div>
	                    <div id="content2">
	                    		...
	                    		<div class="newcolumns">
					                   ...
					                   <div class="maincontent_c">
												 ...
												 <div class="maincontent_c_box4">
					                  			 ...
					                  			 <div class="maincontent_c_box5">
					                  			 <?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Bottom Box #5')) { ?>
			            	     					<?php } ?>
					                  			 </div>
					                  			 <div class="maincontent_c_box6">
					                  			 <?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Bottom Box #6')) { ?>
			            	     					<?php } ?>
					                  			 </div>
