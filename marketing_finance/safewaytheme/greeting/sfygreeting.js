...
// You can safely use $ in this code block to reference jQuery
	...
	$("#greetingContainer1").text('Welcome to Marketing Finance');
	var loc = getAbsolutePath();
	//alert(loc);
	$("a#logo-url").attr("href", loc);
	$("img#logo-url-img").attr("alt", "Safeway Marketing Finance Website");
	$("img#logo-url-img").attr("src", "/marketing_finance/wp-content/themes/safewaytheme/images/safeway-logo250.jpg");
