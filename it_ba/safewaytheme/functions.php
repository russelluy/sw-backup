...
add_filter('logout_url', 'sfy_logout');
function sfy_logout($logout_url, $redirect){
...
wp_enqueue_script( 'it_ba', '/wp-content/themes/safewaytheme/it_ba/it_ba.js', array('jquery'));
