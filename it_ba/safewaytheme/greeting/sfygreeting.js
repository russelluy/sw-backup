...
// You can safely use $ in this code block to reference jQuery
	...
	$("#greetingContainer1").text('Welcome to IT - Business Analysis');
	var loc = getAbsolutePath();
	//alert(loc);
	$("a#logo-url").attr("href", loc);
	$("img#logo-url-img").attr("alt", "IT - Business Analysis");
	$("img#logo-url-img").attr("src", "/it_ba/wp-content/themes/safewaytheme/images/safeway-logo250.jpg");
