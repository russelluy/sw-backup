					...
					<?php while ( have_posts() ) : the_post(); ?>
						...
						<div id="post-<?php the_ID(); ?>" class="<?php hybrid_entry_class(); ?>">
							...
							<div class="post-content">
								...
								<?php echo apply_atomic_shortcode( 'byline', '<div class="byline">' . __( '[entry-published] &middot; by [entry-author] &middot; in [entry-terms taxonomy="category" before=""] [entry-edit-link before=" &middot; "]', 'NorcalTheme' ) . '</div>' ); ?>
								...
								<?php echo apply_atomic_shortcode( 'entry_meta', '<div class="entry-meta">' . __( '[entry-terms taxonomy="post_tag" before="Tags: "]', 'NorcalTheme' ) . '</div>' ); ?>
