...
// You can safely use $ in this code block to reference jQuery
	...
	$("#greetingContainer1").text('Welcome to Pricing');
	var loc = getAbsolutePath();
	//alert(loc);
	$("a#logo-url").attr("href", loc);
	$("img#logo-url-img").attr("alt", "Pricing");
	$("img#logo-url-img").attr("src", "/pricing/wp-content/themes/safewaytheme/images/safeway-logo250.jpg");
