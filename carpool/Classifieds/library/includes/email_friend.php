...

{
	...
	echo '<script>alert(document.getElementById("postmessagediv").innerHTML);</script>';
...
<span style="text-decoration: underline; cursor:pointer;" class="more i_mail3" title="post_message_div"><a href="javascript:void(0)" class=""><?php _e(EMAIL_POST_TEXT);?></a></u></span>



<span id="tellafrnd_success_msg_span"></span>

<div style="display: none;" id="postmessagediv" class="post_message_div hide">

  <iframe src="<?php $id = $post->ID; echo get_option('siteurl')."/?page=email_frnd&pid=$id";?>" height="470" width="600"></iframe>
