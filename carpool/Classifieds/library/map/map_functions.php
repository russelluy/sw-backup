...
if(!function_exists('get_location_map_javascripts'))
{
	...
	{
		$general_settings = get_option('mysite_general_settings');
	?>
...
google.maps.event.addListener(map, 'zoom_changed', function() {
  ...
  function centerChanged() {
    ...
    document.getElementById('post_location').innerHTML = '';
  ...
  function reverseGeocodeResult(results, status) {
    ...
    if(status == 'OK') {
      if(results.length == 0) {
        document.getElementById('post_location').innerHTML = 'None';
      } else {
        document.getElementById('post_location').innerHTML = results[0].formatted_address;
      }
    } else {
      document.getElementById('post_location').innerHTML = 'Error';
    }
  }
