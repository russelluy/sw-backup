...
function safewaytheme_post_meta_boxes() {
  ...
  $meta_boxes = array(
    ...
    "portfolio_link" => array(
      ...
      "title" => "Detail link",
      "description" => "please enter image or video url here, will be used for  pop up lightbox and single page.<br/>Images : <br />http://wp-demo.indonez.com/safewaytheme/wp-content/uploads/2010/07/image.jpg<br/> Video : <br />
      http://www.youtube.com/watch?v=tESK9RcyexU<br />
      http://vimeo.com/12816548<br />
      http://wp-demo.indonez.com/safewaytheme/wp-content/uploads/2010/07/sample.3gp<br />
      http://wp-demo.indonez.com/safewaytheme/wp-content/uploads/2010/07/sample.mp4<br />
      http://wp-demo.indonez.com/safewaytheme/wp-content/uploads/2010/07/sample.mov<br />
	...
	return apply_filters( 'safewaytheme_post_meta_boxes', $meta_boxes );
}

function safewaytheme_page_meta_boxes() {
  ...
  $meta_boxes = array(
	...
	return apply_filters( 'safewaytheme_page_meta_boxes', $meta_boxes );
}

function post_meta_boxes() {
	global $post;
	$meta_boxes = safewaytheme_post_meta_boxes(); ?>
...
function page_meta_boxes() {
	global $post;
	$meta_boxes = safewaytheme_page_meta_boxes(); ?>
...
function safewaytheme_create_meta_box() {
	global $theme_name;
...
function safewaytheme_save_meta_data( $post_id ) {
	global $post;

	if ( 'page' == $_POST['post_type'] )
		$meta_boxes = array_merge( safewaytheme_page_meta_boxes() );
	else
		$meta_boxes = array_merge( safewaytheme_post_meta_boxes() );
...
/* Add a new meta box to the admin menu. */
	add_action( 'admin_menu', 'safewaytheme_create_meta_box' );

/* Saves the meta box data. */
	add_action( 'save_post', 'safewaytheme_save_meta_data' );
