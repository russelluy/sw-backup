...
// You can safely use $ in this code block to reference jQuery
	...
	$("#greetingContainer1").text('Customer Support Center Website');
	var loc = getAbsolutePath();
	//alert(loc);
	$("a#logo-url").attr("href", loc);
	$("img#logo-url-img").attr("alt", "Customer Support Center Website");
	$("img#logo-url-img").attr("src", "/csc/wp-content/themes/safewaytheme/images/safeway-logo250.jpg");
