...
// You can safely use $ in this code block to reference jQuery
	...
	$("#greetingContainer1").text('Welcome to Safeway Insights');
	var loc = getAbsolutePath();
	//alert(loc);
	$("a#logo-url").attr("href", loc);
	$("img#logo-url-img").attr("alt", "Safeway Insights Website");
	$("img#logo-url-img").attr("src", "/insights/wp-content/themes/safewaytheme/images/safeway-logo250.jpg");
