...
wp_enqueue_script( 'strategicsourcing', '/wp-content/themes/safewaytheme/sfypedia/sfypedia.js', array('jquery'));




/*for safewaypedia custom modal*/
wp_enqueue_style('basicsimplemodalcss', '/wp-content/themes/safewaytheme/sfypedia/sfypedia.css');

wp_enqueue_script('simplemodal', '/wp-content/themes/safewaytheme/sfypedia/jquery.simplemodal-1.4.3.js', array('jquery'));
wp_enqueue_script('acro_script', '/wp-content/themes/safewaytheme/sfypedia/acronym_popup.js', array('jquery'));

//wp_enqueue_script('jqueryForm', '/wp-content/themes/safewaytheme/sfypedia/jquery.form.js');
wp_enqueue_script('updatePost1', '/wp-content/themes/safewaytheme/sfypedia/updatePost.js', array('jquery'));
}    
}
