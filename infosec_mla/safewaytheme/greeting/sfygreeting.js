...
// You can safely use $ in this code block to reference jQuery
	...
	$("#greetingContainer1").text('Welcome to Information Security Manila');
	var loc = getAbsolutePath();
	//alert(loc);
	$("a#logo-url").attr("href", loc);
	$("img#logo-url-img").attr("alt", "Information Security Manila");
	$("img#logo-url-img").attr("src", "/infosec_mla/wp-content/themes/safewaytheme/images/safeway-logo250.jpg");
