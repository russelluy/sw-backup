<?php
/*
Template Name: Market Priced Drug Template
*/
?>
	    ...
	    <div class="new_menuwrap">
            ...
            <div class="bottom-header-bg">
							                <div id="bottom-header">
								                	<div class="mainpics">
								                            <img src="wp-content/themes/safewayhealth/images/mainpics/mainpic16.jpg" title="Market-Priced Drug Program" alt="Market-Priced Drug Program" border="0" />           
								                    </div>	
								                    <div class="mainpics_rt">
								                            <img src="wp-content/themes/safewayhealth/images/messagetitle12.gif"  alt="" border="0" />
								                            <h2>We utilize transparency and market forces to help plan members make informed, cost-effective prescription drug decisions.</h2>
								                    </div>		                    
							                </div>
							                <div class="clear"></div>
					             	</div>
