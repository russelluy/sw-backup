<?php
/*
Template Name: JumpStart Template
*/
?>
	    ...
	    <div class="new_menuwrap">
            ...
            <div class="bottom-header-bg">
							                <div id="bottom-header">
								                	<div class="mainpics">
								                            <img src="wp-content/themes/safewayhealth/images/mainpics/mainpic18.jpg" title="A Team-based Wellness Challenge" alt="A Team-based Wellness Challenge" border="0" />           
								                    </div>	
								                    <div class="mainpics_rt">
								                            <img src="wp-content/themes/safewayhealth/images/messagetitle14.gif"  alt="" border="0" />
								                            <h2>We create a team-based wellness challenge that engages employee interest around active participation in their health journey and creates a culture of health.</h2>
								                    </div>		                    
							                </div>
							                <div class="clear"></div>
					             	</div>
							                ...
							                <div id="bottom-header2">
								                	...
								                	<div class="contentbody">
								                            ...
								                            <div class="contentbody_rt_ourmodel">
								                            		<?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('JumpStart')) { ?>
            	     												<?php } ?>
								                            </div>	         
								                    </div>		                    
							                </div>
