	    ...
	    <div class="new_menuwrap">
            ...
            <div class="bottom-header-bg">
							                <div id="bottom-header">
								                	<div class="mainpics">
								                            <img src="wp-content/themes/safewayhealth/images/mainpics/mainpic12.jpg" title="Join Our Team" alt="Join Our Team" border="0" />           
								                    </div>	
								                    <div class="mainpics_rt">
								                            <img src="wp-content/themes/safewayhealth/images/messagetitle8g.gif"  alt="" border="0" />
								                            <h2>Become a part of the team that is transforming healthcare.</h2>
								                    </div>		                    
							                </div>
							                <div class="clear"></div>
					             	</div>
