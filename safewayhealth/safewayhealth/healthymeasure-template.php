<?php
/*
Template Name: Healthy Measures Template
*/
?>
	    ...
	    <div class="new_menuwrap">
            ...
            <div class="bottom-header-bg">
							                <div id="bottom-header">
								                	<div class="mainpics">
								                            <img src="wp-content/themes/safewayhealth/images/mainpics/mainpic17.jpg" title="Transforming Behaviors into Currency" alt="Transforming Behaviors into Currency" border="0" />           
								                    </div>	
								                    <div class="mainpics_rt">
								                            <img src="wp-content/themes/safewayhealth/images/messagetitle13.gif"  alt="" border="0" />
								                            <h2>Link biometrics to financial incentives, leveraging market forces to motivate healthy behavior. </h2>
								                    </div>		                    
							                </div>
							                <div class="clear"></div>
					             	</div>
