<?php
/*
Template Name: Integrating Health Template
*/
?>
	    ...
	    <div class="new_menuwrap">
            ...
            <div class="bottom-header-bg">
							                <div id="bottom-header">
								                	<div class="mainpics">
								                            <img src="wp-content/themes/safewayhealth/images/mainpics/mainpic19.jpg" title="Building a Culture of Health and Fitness" alt="Building a Culture of Health and Fitness" border="0" />           
								                    </div>	
								                    <div class="mainpics_rt">
								                            <img src="wp-content/themes/safewayhealth/images/messagetitle15.gif"  alt="" border="0" />
								                            <h2>We provide the tools to help put your organization on the road to long-term control of your healthcare costs. </h2>
								                    </div>		                    
							                </div>
							                <div class="clear"></div>
					             	</div>
							                ...
							                <div id="bottom-header2">
								                	...
								                	<div class="contentbody">
								                            ...
								                            <div class="contentbody_rt_ourmodel">
								                            		<?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('HealthyMeasures')) { ?>
            	     												<?php } ?>
								                            </div>	         
								                    </div>		                    
							                </div>
