...
<?php if(isset($emailSent) && $emailSent == true) { ?>
                    	...
                    	<div class="thanks">
                    		<h3>Thanks, <?=$name;?></h3>
                    		<p><?php echo __('Your email was successfully sent. I will be in touch soon.','safewayhealth');?></p>
                    	</div>
                    ...
                    <?php } else { ?>
                    	...
                    	<?php while (have_posts()) : the_post(); ?>
                    		...
                    		<?php if(isset($hasError) || isset($captchaError)) { ?>
                    			<p class="error"><?php echo __('There was an error submitting the form.','safewayhealth');?><p>
                    		<?php } ?>
                    	
                    		<form action="<?php the_permalink(); ?>" id="contactForm" method="post">
                    	
                    			<ol class="forms">
				<li><label for="contactName"><?php echo __('Name','safewayhealth');?></label>
			 ...
			 <li><label for="email"><?php echo __('Email','safewayhealth');?></label>
  			 ...
  			 <li><label for="subject"><?php echo __('Subject','safewayhealth');?></label>
				...
				<li class="textarea"><label for="commentsText"><?php echo __('Message','safewayhealth');?></label>
				...
				<li class="screenReader"><label for="checking" class="screenReader"><?php echo __('If you want to submit this form, do not enter anything in this field','safewayhealth');?></label><input type="text" name="checking" id="checking" class="screenReader" value="<?php if(isset($_POST['checking']))  echo $_POST['checking'];?>" /></li>
				<li class="buttons"><input type="hidden" name="submitted" id="submitted" value="true" /><button type="submit" class="input-submit"></button></li>
                 ...
                 <div id="side-box">
                   	 <div class="maincontent">
                     <h2><?php bloginfo('blogname');?> <?php echo __('on the map','safewayhealth');?></h2>                            
        				...
        				<?php echo __('Phone ','safewayhealth');?>: <?php if ($contactphone) echo $contactphone; else echo "+62 1234 5678";?>,  <?php echo __('Email', 'safewayhealth');?> : <?php if ($contactemail) echo $contactemail; else echo "info@safewayhealth.com";?>
                        </p>
