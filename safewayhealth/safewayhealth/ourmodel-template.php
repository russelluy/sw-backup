<?php
/*
Template Name: Our Model Template
*/
?>
                    ...
                    <div class="top-header_rt">
                    	<div class="top-header_rt_nav">
                    		<ul id="nav"> 
							   ...
							   <li class="menuLink"><a href="our-model"><img src="wp-content/themes/safewayhealth/images/TopTab4_over.gif" alt="Our Model" border="0"></a></li> 
	    ...
	    <div class="new_menuwrap">
            ...
            <div class="bottom-header-bg">
							                <div id="bottom-header">
								                	<div class="mainpics">
								                            <img src="wp-content/themes/safewayhealth/images/mainpics/mainpic2.jpg" title="Creating Value Together" alt="Creating Value Together" border="0" />           
								                    </div>	
								                    <div class="mainpics_rt">
								                            <img src="wp-content/themes/safewayhealth/images/messagetitle17.gif"  alt="" border="0" />
								                            <h2>We are your partners in health benefits redesign with solutions that can create tremendous value. </h2>
								                    </div>		                    
							                </div>
							                <div class="clear"></div>
					             	</div>
							                ...
							                <div id="bottom-header2">
								                	...
								                	<div class="contentbody">
								                            ...
								                            <div class="contentbody_rt_ourmodel">
								                            		<?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Our Model Box')) { ?>
            	     												<?php } ?>
								                            </div>	         
								                    </div>		                    
							                </div>
