<?php
/*
Template Name: Our Results Template
*/
?>
                    ...
                    <div class="top-header_rt">
                    	<div class="top-header_rt_nav">
                    		<ul id="nav"> 
							   ...
							   <li class="menuLink"><a href="our-results"><img src="wp-content/themes/safewayhealth/images/TopTab5_over.gif" alt="Our Results" border="0"></a></li>
	    ...
	    <div class="new_menuwrap">
            ...
            <div class="bottom-header-bg">
							                <div id="bottom-header">
								                	<div class="mainpics">
								                            <img src="wp-content/themes/safewayhealth/images/mainpics/mainpic3.jpg" title="Cost Control and a Healthy Workforce" alt="Cost Control and a Healthy Workforce" border="0" />           
								                    </div>	
								                    <div class="mainpics_rt">
								                            <img src="wp-content/themes/safewayhealth/images/messagetitle16.gif"  alt="" border="0" />
								                            <h2>Safeway Health enables your employees to take charge of their health and reduce costs for both them and your organization.</h2>
								                    </div>		                    
							                </div>
							                <div class="clear"></div>
					             	</div>
							                ...
							                <div id="bottom-header2">
								                	...
								                	<div class="contentbody">
								                            ...
								                            <div class="contentbody_rt_ourmodel">
								                            		<?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Our Results Box')) { ?>
            	     												<?php } ?>
								                            </div>	         
								                    </div>		                    
							                </div>
