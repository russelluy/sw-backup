...
// You can safely use $ in this code block to reference jQuery
	...
	$("#greetingContainer1").text('Welcome to Strategic Sourcing');
	var loc = getAbsolutePath();
	//alert(loc);
	$("a#logo-url").attr("href", loc);
	$("img#logo-url-img").attr("alt", "Safeway Strategic Sourcing");
	$("img#logo-url-img").attr("src", "/strategicsourcing/wp-content/themes/safewaytheme/images/safeway-logo250.jpg");
