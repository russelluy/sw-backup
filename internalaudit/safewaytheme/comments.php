...
?>
<?php if ('open' == $post->comment_status) : ?>
<div class="related-comment-title"><h2><?php echo __('Leave a comment', 'safewaytheme');?></h2></div><br />
...
<fieldset>
<?php if ( $user_ID ) : ?>
<p>Logged in as <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo wp_logout_url(get_permalink());?>" title="Log out of this account"><?php echo __('Logout &raquo;', 'safewaytheme');?></a></p>
<?php else : ?>
...
<!--<p><small><strong>XHTML:</strong> You can use these tags: <?php echo allowed_tags(); ?></small></p>-->
			<label for="comment"><?php echo __('Comment', 'safewaytheme');?> <span><?php echo __('(required)');?></span></label>
