...
// You can safely use $ in this code block to reference jQuery
	...
	$("#greetingContainer1").text('Welcome to Card and Loyalty Marketing');
	var loc = getAbsolutePath();
	//alert(loc);
	$("a#logo-url").attr("href", loc);
	$("img#logo-url-img").attr("alt", "Safeway Card and Loyalty Marketing Website");
	$("img#logo-url-img").attr("src", "/cardandloyaltymarketing/wp-content/themes/safewaytheme/images/safeway-logo250.jpg");
