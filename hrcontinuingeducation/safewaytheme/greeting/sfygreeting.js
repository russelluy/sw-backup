...
// You can safely use $ in this code block to reference jQuery
	...
	$("#greetingContainer1").text('Welcome to HR - Continuing Education');
	var loc = getAbsolutePath();
	//alert(loc);
	$("a#logo-url").attr("href", loc);
	$("img#logo-url-img").attr("alt", "Safeway HR -  Continuing Education");
	$("img#logo-url-img").attr("src", "/hrcontinuingeducation/wp-content/themes/safewaytheme/images/safeway-logo250.jpg");
