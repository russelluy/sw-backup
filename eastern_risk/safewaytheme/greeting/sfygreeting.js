...
// You can safely use $ in this code block to reference jQuery
	...
	$("#greetingContainer1").text('Welcome to Risk Management');
	var loc = getAbsolutePath();
	//alert(loc);
	$("a#logo-url").attr("href", loc);
	$("img#logo-url-img").attr("alt", "Safeway Risk Management");
	$("img#logo-url-img").attr("src", "/eastern_risk/wp-content/themes/safewaytheme/images/safeway-logo250.jpg");
