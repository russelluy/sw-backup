  ...
  register_sidebar(array(
   ...
   register_sidebar(array(
    ...
    'after_title' => '</h2>'
      ...
      register_sidebar(array(
    'name'=>'financialanalytic Sidebar',
    'before_widget' => '<div class="maincontent"><div class="widgets">',
    'after_widget' => '</div></div>',
    'before_title' => '<h2>',
    'after_title' => '</h2>'
...
class SidePage_Widget extends WP_Widget {
  function SidePage_Widget() {
    ...
    parent::WP_Widget(false,$name= "safewaytheme - Side Page",$widgets_opt);
  }
...
class LatestNews_Widget extends WP_Widget {
  ...
  function LatestNews_Widget() {
    $widgets_opt = array('description'=>'Latest News safewaytheme Theme Widget');
    parent::WP_Widget(false,$name= "safewaytheme - Latest News",$widgets_opt);
  }
  ...
  function widget( $args, $instance ) {
    ...
    if ($newstitle == "") $newstitle = __("Latest News",'safewaytheme');
...
class Testimonial_Widget extends WP_Widget {
  function Testimonial_Widget() {
    $widgets_opt = array('description'=>'Testimonial safewaytheme Theme Widget');
    parent::WP_Widget(false,$name= "safewaytheme - Testimonial",$widgets_opt);
  }
...
/* Post to Homepage Box or Sidebar Box*/

class SidePost_Widget extends WP_Widget {
  
  function SidePost_Widget() {
    $widgets_opt = array('class'=>'box','description'=>'safewaytheme Theme Widget for displaying post in sidebar');
    parent::WP_Widget(false,$name= "safewaytheme - Side Post",$widgets_opt);  
  }
...
class FeaturedProject_Widget extends WP_Widget {
  function FeaturedProject_Widget() {
    $widgets_opt = array('description'=>'Featured Project safewaytheme Theme Widget');
    parent::WP_Widget(false,$name= "safewaytheme - Featured Message ",$widgets_opt);
  }
  ...
  function widget( $args, $instance ) {
    ...
    if ($featuredtitle == "") $featuredtitle = __('Featured Project','safewaytheme');
    if ($featurednum == "") $featurednum = 3;
    
    echo $before_widget;
    $titlefeatured = $before_title.$featuredtitle.$after_title;
    safewaytheme_featuredproject($featuredcat,3,$titlefeatured);
    echo $after_widget;
  } 
}
...
class SocialLink_Widget extends WP_Widget {
  function SocialLink_Widget() {
    ...
    parent::WP_Widget(false,$name= "safewaytheme - Social Links ",$widgets_opt);
  }
  ...
  function widget( $args, $instance ) {
    ...
    if ($socialtitle == "") $socialtitle = __('Get Connected','safewaytheme');
...
class Twitter_Widget extends WP_Widget {
  function Twitter_Widget() {
    $widgets_opt = array('description'=>'safewaytheme Twitter Widget');
    parent::WP_Widget(false,$name= "safewaytheme - Twitter Widget",$widgets_opt);
  }
  ...
  function widget( $args, $instance ) {
    ...
    if ($twittertitle == "") $twittertitle = __('Twitter Update!','safewaytheme');
...
class Adbanner_Widget extends WP_Widget {
  function Adbanner_Widget() {
    ...
    parent::WP_Widget(false,$name= "safewaytheme - Banner Widget",$widgets_opt);
  }
  ...
  function widget( $args, $instance ) {
    ...
    if ($bannertitle == "") $bannertitle = __('Sponsor','safewaytheme');
...
class Address_Widget extends WP_Widget {
  function Address_Widget() {
    $widgets_opt = array('description'=>'safewaytheme Company Address Widget');
    parent::WP_Widget(false,$name= "safewaytheme - Address Widget ",$widgets_opt);
  }
  ...
  function widget( $args, $instance ) {
    ...
    if ($addresstitle == "") $addresstitle = __('Our Address','safewaytheme');
...
<?php echo __('Phone ','safewaytheme');?>: <?php if ($contactphone) echo $contactphone; else echo "+62 1234 5678";?>,  <?php echo __('Email ','safewaytheme');?>: <?php if ($contactemail) echo $contactemail; else echo "info@safewaytheme.com";?><br />
  <?php $footer_text = get_option('Ag_footer_text');?>
  <?php if ($footer_text) echo stripslashes($footer_text); else echo "Copyright &copy; 2009 safewaytheme. All Rights Reserved";?><br />
  </p>
  <?php
    echo $after_widget;
  } 
