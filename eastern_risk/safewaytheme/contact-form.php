<?php
/*
Template Name: Safeway Contact Template
*/
?>
...
<?php if(isset($emailSent) && $emailSent == true) { ?>
                    ...
                    <?php } else { ?>
                    	...
                    	<br /><br />
                    		<form action="<?php the_permalink(); ?>" id="contactForm" method="post">
                    			...
                    			<ol class="forms">
				<li><label for="contactName"><?php echo __('Name','safewaytheme');?></label>
			 ...
			 <li><label for="email"><?php echo __('Email','safewaytheme');?></label>
  			 ...
  			 <li><label for="subject"><?php echo __('Subject','safewaytheme');?></label>
				...
				<li class="textarea"><label for="commentsText"><?php echo __('Message','safewaytheme');?></label>
				...
				<li class="screenReader"><label for="checking" class="screenReader"><?php echo __('If you want to submit this form, do not enter anything in this field','safewaytheme');?></label><input type="text" name="checking" id="checking" class="screenReader" value="<?php if(isset($_POST['checking']))  echo $_POST['checking'];?>" /></li>
				<li class="buttons"><input type="hidden" name="submitted" id="submitted" value="true" /><button type="submit" class="input-submit"></button></li>
                 ...
                 <div id="side-box" style="margin-top:20px;">
                   	 <div class="maincontent">
                     <h2><?php bloginfo('blogname');?> <?php echo __('on the map','safewaytheme');?></h2>                            
        				...
        				<?php echo __('Phone ','safewaytheme');?>: <?php if ($contactphone) echo $contactphone; else echo "+62 1234 5678";?>,  <?php echo __('Email', 'safewaytheme');?> : <?php if ($contactemail) echo $contactemail; else echo "info@safewaytheme.com";?>
                        </p>
