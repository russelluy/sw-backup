...
// You can safely use $ in this code block to reference jQuery
	...
	$("#greetingContainer1").text('Welcome to BCM');
	var loc = getAbsolutePath();
	//alert(loc);
	$("a#logo-url").attr("href", loc);
	$("img#logo-url-img").attr("alt", "BCM");
	$("img#logo-url-img").attr("src", "/bcm/wp-content/themes/safewaytheme/images/safeway-logo250.jpg");
