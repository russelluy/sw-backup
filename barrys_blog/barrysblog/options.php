...
function optionsframework_options() {
	...
	$options[] = array(
		...
		'id' => 'footer_text',
		'std' => 'Copyright &copy; {year} · Theme design by the barry Company · www.barry.is',
		'type' => 'text');
	...
	$options[] = array(
		...
		'desc' => __('Select what kind of ad you want added above the top menu. <a target="_blank" href="http://www.barry.is/wordpress/barrysblog/wp-content/uploads/2013/07/ad_above_example.png">See Example</a>', 'options_framework_theme'),
		'id' => 'ad_header_mode',
		'std' => 'none',
		'type' => 'radio',
		'options' => array(
