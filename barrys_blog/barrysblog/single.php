			...
			?>
				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<div class="single-pagination box clearfix">
						<span class="nav-previous" style="float:left;"><?php previous_post_link( '%link', '<span><i class="icon-left-open"></i>'.__('Older', 'barry').'</span><br/><div class="post-title hidden-tablet hidden-phone">%title</div>' ); ?></span>
						<span class="nav-next" style="float:right;"><?php next_post_link( '%link', '<span>'.__('Newer', 'barry').'<i class="icon-right-open"></i></span><br/><div class="post-title hidden-tablet hidden-phone">%title</div>' ); ?></span>
					</div>
				...
				<article class="post error">
					<h1 class="404"><?php _e('Page not found', 'barry'); ?></h1>
				</article>
