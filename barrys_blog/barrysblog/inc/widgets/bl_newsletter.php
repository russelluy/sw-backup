...
class bl_newsletter extends WP_Widget
{
  function bl_newsletter(){
    ...
    $this->WP_Widget('bl_newsletter', 'barry Newsletter', $widget_ops);
  }
    ...
    <div class="bl_newsletter">
      ...
      <div class="widget-body">
	    ...
	    <div class="input-append">
		    <input class="span3" id="bl_newsletter_email" type="text" placeholder="<?php _e('Email address', 'barry'); ?>">
		    <button class="btn btn-primary" type="button"><?php _e('Subscribe!', 'barry'); ?></button>
	    </div>
      </div>
